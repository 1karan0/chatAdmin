...
(function() {
  ...
  async function initSession() {
    ...
    try {
      const res = await fetch('https://chat-admin-silk.vercel.app/chat/session?tenant_id=' + tenantId);
  ...
  async function sendMessage(text = null) {
    ...
    try {
      const response = await fetch('https://chat-admin-silk.vercel.app/chat/ask', {
        method: 'POST',
